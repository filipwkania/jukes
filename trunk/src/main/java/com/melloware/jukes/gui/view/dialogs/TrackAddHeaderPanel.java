...
/**AZ 2009
 * The custom header for the Track add dialog with toolbar.
 * <p>
 * Copyright (c) 1999-2007 Melloware, Inc. <http://www.melloware.com>
 * @author Emil A. Lefkof III <info@melloware.com>
 * @version 4.0
 */
public final class TrackAddHeaderPanel
    extends GradientBackgroundPanel {

    public static final int DEFAULT_HEIGHT = 70;
    private TrackAddDialog owner;
     ...
     */
    public TrackAddHeaderPanel(TrackAddDialog owner, String title, String description, Icon icon) {
