...
public final class StatisticsDialog extends AbstractDialog {
   ...
   protected JComponent buildApplicationTab() {
      // JPanel table = new ApplicationStats();
   ...
   protected JComponent buildHeader() {
      return new HeaderPanel(Resources.getString("label.Statistics"), Resources.getString("label.StatisticsMessage"),
               Resources.STATS_LARGE_ICON);
   }
