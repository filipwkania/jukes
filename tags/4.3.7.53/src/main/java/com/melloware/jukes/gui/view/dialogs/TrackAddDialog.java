      ...
      if (dialog.getSelectedImage() != null) {
         try {
            if (this.coverImage == null) {
               ...
               String imageLocation = ImageFactory.saveImageWithFileFormat(dialog.getSelectedImage(), this.settings
                        .getFileFormatImage(), FilenameUtils.getFullPath(this.directory), artistField.getText(),
                        discField.getText(), yearField.getText());
